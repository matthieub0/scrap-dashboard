            ...
            <div className="flex items-center gap-2 mt-3 flex-wrap">
              ...
              {linkedinUrl && (
                <button
                  ...
                  disabled={enriching}
                  className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-md text-xs font-medium border border-border text-muted-foreground hover:text-foreground hover:border-gold/30 transition-colors disabled:opacity-50"
                >
                  {enriching ? (
                    <>
                      <svg className="w-3 h-3 animate-spin" fill="none" viewBox="0 0 24 24">
